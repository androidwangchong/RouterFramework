...
import com.base.app.ethprotocol.data.WatchWallet;
import com.base.app.ethprotocol.interfaces.StorableWallet;
import com.base.app.event.EnsurePasswordErrorEvent;
...
public class WalletStorage {
    ...
    private ArrayList<StorableWallet> mapdb = new ArrayList<>();
...
//    }
    ...
    public Credentials getFullWallet(Context context, String password, String wallet) throws IOException, JSONException, CipherException {
        ...
        try{
            ...
            EventBus.getDefault().post(new EnsurePasswordErrorEvent());
        }
        return null;
    }
    ...
    public synchronized void load(Context context) throws IOException, ClassNotFoundException {
        File file = new File(context.getFilesDir(), "wallets.dat");
        if (file.exists()) {
